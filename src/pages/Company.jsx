...
function TeamCard({ member }) {
  ...
  return (
    <div className="[perspective:1400px]">
      ...
      >
        {/* front */}
        <div className="absolute inset-0 overflow-hidden rounded-2xl ring-2 ring-super-red [backface-visibility:hidden]">
          {member.photo ? (
        ...
        {/* back */}
        <div className="absolute inset-0 overflow-y-auto rounded-2xl bg-super-red p-6 [backface-visibility:hidden] [transform:rotateY(180deg)]">
...
export default function Company() {
  ...
  return (
    <section className="px-6 py-16 md:px-10">
      ...
      <div ref={btsRef} className="grid grid-cols-2 gap-4 md:grid-cols-5 md:gap-5">
        {btsPhotos.map((src, i) => (
          <div
            key={src}
            className={`overflow-hidden rounded-xl transition-all duration-700 ${
              i % 2 === 0 ? "md:mt-10" : "md:mb-10"
      ...
      <h1 className="mt-16 max-w-4xl font-display text-4xl uppercase leading-[1.05] text-super-red md:text-6xl">
        {companyIntro}
      </h1>

      <h2 className="mt-20 font-display text-3xl text-super-red md:text-5xl">OUR TEAM</h2>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex h-[30rem] items-center justify-center rounded-2xl text-center text-sm uppercase tracking-wide text-super-red/40 ring-2 ring-dashed ring-super-red/30">
          Second team member
          <br />
          coming soon
        </div>
      ...
      <h2 className="mt-20 font-display text-3xl text-super-red md:text-5xl">COLLABORATORS</h2>
